...
def index(request):
    ...
    np_valid_pred = np.load('./methylation/app/y_valid_pred.npy')
    np_valid_real = np.load('./methylation/app/y_valid_real.npy')
...
def click_point(request):
    ...
    if request.method == 'POST':
        ...
        np_x_test = np.load('./methylation/app/X_test.npy')
